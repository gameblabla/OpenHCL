...
int sys_Init()
{
	...
	if (fileExists("sd:/apps/OpenHCL/bmp.qda")) {
	...
	else if (fileExists("carda:/apps/OpenHCL/bmp.qda")) {
		SYS_DATAPATH 	 = "carda:/apps/OpenHCL/";
		SYS_INIPATH  	 = "carda:/apps/OpenHCL/system.ini";
		SYS_SAVEPATH 	 = "carda:/apps/OpenHCL/map/018.map";
		SYS_TEMPSAVEPATH = "carda:/apps/OpenHCL/data/save.tmp";
	}
	else if (fileExists("cardb:/apps/OpenHCL/bmp.qda")) {
		SYS_DATAPATH 	 = "cardb:/apps/OpenHCL/";
		SYS_INIPATH  	 = "cardb:/apps/OpenHCL/system.ini";
		SYS_SAVEPATH 	 = "cardb:/apps/OpenHCL/map/018.map";
		SYS_TEMPSAVEPATH = "cardb:/apps/OpenHCL/data/save.tmp";
	}
	else if (fileExists("dvd:/apps/OpenHCL/bmp.qda")) {
		SYS_DATAPATH 	 = "dvd:/apps/OpenHCL/";
		SYS_INIPATH  	 = "dvd:/apps/OpenHCL/system.ini";
		SYS_SAVEPATH 	 = "dvd:/apps/OpenHCL/map/018.map";
		SYS_TEMPSAVEPATH = "dvd:/apps/OpenHCL/data/save.tmp";
	}
	else {
